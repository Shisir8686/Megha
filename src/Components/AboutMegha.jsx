...
const AboutMegha = () => {
  return (
    <div className="container mx-auto p-6 md:p-10 my-10 mt-24 flex justify-center items-center">
      <div className="flex  md:flex-row md:items-center gap-8 md:gap-12 flex-col-reverse"> {/* Increased gap for more spacing */}
        <div className="w-full md:w-1/2 md:pr-10"> {/* Added right padding on medium screens */}
          <h1
            data-aos="fade-up"
            data-aos-delay="200"
            className="font-semibold lg:text-6xl md:text-4xl text-3xl text-red-500 mb-12 tracking-tight leading-tight" // Adjusted text size, added tracking and leading
          >
          ...
          <p
            ...
            data-aos-delay="300"
            data-aos-offset="200"
            className="text-gray-500 dark:text-gray-300 text-base lg:text-2xl leading-relaxed" // Adjusted text size and line height
          >
